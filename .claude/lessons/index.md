...
- Agent-side code changes require container image rebuild (`make build-local`) [providers/sandbox.md](providers/sandbox.md)
- Sandbox "bash" tool returns "Command failed" for successful commands with no output [providers/sandbox.md](providers/sandbox.md)
...
- tryClaim minuteKey dedup is insufficient — need in-flight tracking for long-running jobs [providers/scheduler.md](providers/scheduler.md)
