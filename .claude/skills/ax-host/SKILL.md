...
In k8s mode, `host-process.ts` handles symmetric workspace file transfer between GCS and sandbox pods. The host is the single GCS credential holder — pods never access GCS directly.
